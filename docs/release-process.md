...
2. Verify Node 22 and 24 CI: clean install, build, typecheck, lint/security
   scan, tests, isolation, text-layout data verification, diagnostic
   determinism, fixtures, dependency licenses, audit, packing, and coverage.
...
7. Inspect `npm pack --dry-run`, then install the local archive in a fresh
